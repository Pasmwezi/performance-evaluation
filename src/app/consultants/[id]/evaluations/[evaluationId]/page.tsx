...
export default async function ConsultantEvaluationPage({ params }: PageProps<"/consultants/[id]/evaluations/[evaluationId]">) {
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="app-card p-6">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <DetailItem label="Amendments" value={evaluation.amendmentsCount} />
          </div>
        </div>
      </section>
